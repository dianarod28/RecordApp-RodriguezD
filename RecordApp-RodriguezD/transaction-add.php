                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 px-1">
                                                <div class="form-group">
                                                    ...
                                                    <input name="documentcode" type="text" class="form-control" placeholder="documentcode">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <?php
                                                        $query = "SELECT id, CONCAT(lastname,', ',firstname) as EmployeeFullname FROM recordsapp_db.employee;";
